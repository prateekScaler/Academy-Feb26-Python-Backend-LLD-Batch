...
|---|---|---|
| **defaultdict** | `if key not in d: d[key] = []` | Dict with auto-created missing keys |
| **Counter** | Manual counting loops | Count things from any iterable |
| **deque** | `list.insert(0, x)` (O(n)!) | Fast append/pop from both ends |
| **namedtuple** | `point[0]` — what is 0? | Tuple with named fields |
| **OrderedDict** | Order-aware comparisons | Dict with order-sensitive equality |
| **ChainMap** | `{**defaults, **overrides}` | Layered dict lookups |
...
- [collections module](https://docs.python.org/3/library/collections.html) — defaultdict, Counter, deque, namedtuple, OrderedDict, ChainMap, UserDict/UserList/UserString
- [frozenset](https://docs.python.org/3/library/stdtypes.html#frozenset) — immutable set type
- [queue.Queue](https://docs.python.org/3/library/queue.html) — thread-safe queue
- [typing.NamedTuple](https://docs.python.org/3/library/typing.html#typing.NamedTuple) — typed namedtuple syntax
- [Data Structures Tutorial](https://docs.python.org/3/tutorial/datastructures.html) — official tutorial on lists, dicts, sets, tuples
