...
E-commerce & Marketplace LLD problems test **catalog, cart, order lifecycle**. Work the [playbook](#the-lld-playbook-use-it-on-every-problem) below on each worksheet in this folder, then reveal the sample requirements to check yourself.

## Case studies in this category

| Case study | Difficulty | Key concepts |
|---|---|---|
| Shopping Cart | Medium | Cart operations, inventory, pricing |
| Food Delivery | Hard | Restaurant, menu, order tracking, delivery |
