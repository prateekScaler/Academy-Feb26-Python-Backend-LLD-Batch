# Category Guide: Scheduling & Calendar

## Overview

Scheduling & Calendar LLD problems test **recurring events, timezones, conflicts**. Work the [playbook](#the-lld-playbook-use-it-on-every-problem) below on each worksheet in this folder, then reveal the sample requirements to check yourself.

## Case studies in this category

| Case study | Difficulty | Key concepts |
|---|---|---|
| Calendar | Hard | Recurring events, timezones, conflicts |
| Meeting Scheduler | Medium | Free/busy, interval overlap, rooms |
