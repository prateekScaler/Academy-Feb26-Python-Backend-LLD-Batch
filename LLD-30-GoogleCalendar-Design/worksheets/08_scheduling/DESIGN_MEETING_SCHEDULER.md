...
- [Design Meeting Scheduler](#design-meeting-scheduler)
  - [Overview](#overview)
...
Given attendees and a duration, find a slot when everyone is free and book a room; the core is interval intersection.

> **Difficulty:** Medium &nbsp;·&nbsp; **Key concepts:** Free/busy, interval overlap, rooms
...
<details>
  ...
  1. Each attendee has a set of busy intervals.
  2. Given attendees + duration + window, propose the earliest common free slot.
  3. Book a meeting room that is free for the slot.
  4. No two meetings share a room at overlapping times.
  5. Detect conflicts for an attendee.
  6. Support a required vs optional attendee distinction.
  7. Send invites and collect responses.
  8. Suggest alternative slots if none fits.
</details>
