...
Content & Media Management LLD problems test **catalog, search, access control**. Work the [playbook](#the-lld-playbook-use-it-on-every-problem) below on each worksheet in this folder, then reveal the sample requirements to check yourself.

## Case studies in this category

| Case study | Difficulty | Key concepts |
|---|---|---|
| Library Management | Medium | Catalog, borrow/return, fines |
| File Storage / Drive | Medium | Hierarchy, sharing, permissions |
