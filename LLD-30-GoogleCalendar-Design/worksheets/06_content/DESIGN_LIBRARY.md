...
- [Design Library Management](#design-library-management)
  - [Overview](#overview)
...
Members search a catalog and borrow/return books; copies, due dates, and fines must be tracked.

> **Difficulty:** Medium &nbsp;·&nbsp; **Key concepts:** Catalog, borrow/return, fines
...
<details>
  ...
  1. A catalog of books, each with one or more physical copies.
  2. Members can search by title/author/subject.
  3. A member can borrow an available copy (with a borrow limit).
  4. Borrowing sets a due date; returning frees the copy.
  5. Late returns incur a fine.
  6. Reserve a book that is currently all borrowed.
  7. Track which member holds which copy.
  8. Librarian can add/remove books and copies.
</details>
